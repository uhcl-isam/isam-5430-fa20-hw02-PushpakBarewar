...
namespace CSharp.Assignments.ConsoleLoop1
{
    ...
    ///  The app should calculate and display the miles per gallon obtained for each tankful and 
    /// display the combined miles per gallon obtained for all tankfuls up to this point. 
    /// All averaging calculations should produce floating-point results. 
    /// Display the miles per gallons on one line and the total miles per gallons on another, both rounded to the
